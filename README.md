...
### Chrome
1. Download the [latest release](https://github.com/gchenfc/sci-hub-now/releases/download/v0.0.3/sci-hub-now_v0.0.3_chrome.zip) or the current [master](https://github.com/gchenfc/sci-hub-now/archive/master.zip) and unzip
...
### Firefox
1. [Click here](https://github.com/gchenfc/sci-hub-now/releases/download/v0.0.3/sci-hub-now_v0.0.3_firefox.xpi) for the latest release - Firefox should automatically prompt you to "Add Sci-Hub X Now!".
